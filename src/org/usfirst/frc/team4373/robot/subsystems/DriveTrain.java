...
public class DriveTrain extends PIDSubsystem {
    ...
    public DriveTrain() {
        ...
        this.left1.enableBrakeMode(false);
        this.left1.reverseOutput(false);
        this.left1.setVoltageRampRate(0.8);
        this.left2 = new CANTalon(RobotMap.LEFT_DRIVE_MOTOR_2);
        this.left2.enableBrakeMode(false);
        ...
        this.right1.enableBrakeMode(false);
        this.right1.reverseOutput(false);
        this.right1.setVoltageRampRate(0.8);
        this.right2 = new CANTalon(RobotMap.RIGHT_DRIVE_MOTOR_2);
        this.right2.enableBrakeMode(false);
